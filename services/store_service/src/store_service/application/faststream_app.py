...
async def initialize_app() -> None:
    ...
    create_product_exchange = await rabbit_broker.declare_exchange(
    ...
    update_product_exchange = await rabbit_broker.declare_exchange(
    ...
    delete_product_exchange = await rabbit_broker.declare_exchange(
