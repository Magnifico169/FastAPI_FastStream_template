...
class UserService:
    ...
    def __init__(
        ...
        :param products_repository: Product repository
        :param order_repository: Order repository
        """
    ...
    async def cancel_order(self, order: Order) -> None:
        ...
        :param order: removing order
        :return: Optional[Order] or None
        """
