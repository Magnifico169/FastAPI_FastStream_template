...
from typing import AsyncGenerator, ClassVar, Annotated
...
from models.settings import get_postgres_settings
...
class PostgresSessionFactory:
    ...
    _session_factory: ClassVar[async_sessionmaker | None] = None
    ...
    def initialize(cls) -> None:
        ...
        database_url = postgres_settings.get_postgres_uri().replace(postgres_settings.POSTGRES_DRIVER, async_driver)
