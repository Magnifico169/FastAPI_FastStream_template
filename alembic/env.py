...
from common.persistence.models import base_table
...
config.set_main_option("sqlalchemy.url", postgres_settings.get_postgres_uri())
target_metadata = base_table.BaseTable.metadata
